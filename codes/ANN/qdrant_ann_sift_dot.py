...
if os.path.exists('qdrant_ann_sift_results_dot.csv'):
    with open('qdrant_ann_sift_results_dot.csv', 'r') as file:
        ...
        for ef_construct in ef_construction_values:
            ...
            for limit in limit_values:
                for ef_search in ef_search_values:
                    ...
                    # Log results
                    with open('qdrant_ann_sift_results_dot.csv', 'a', newline='') as file:
