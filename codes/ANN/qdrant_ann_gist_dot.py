...
base_vectors_path = '../../data/base_vectors_gist.pkl'
query_vectors_path = '../../data/query_vectors_gist.pkl'

base_vectors = load_vectors_from_pickle(base_vectors_path)['vector']
query_vectors = load_vectors_from_pickle(query_vectors_path)['vector']
...
ground_truth_path = '../../data/ground_truth_dot_gist.pkl'

# Track completed experiments
completed_experiments = set()
if os.path.exists('results/qdrant_ann_gist_results_dot.csv'):
    with open('results/qdrant_ann_gist_results_dot.csv', 'r') as file:
        ...
        for ef_construct in ef_construction_values:
            ...
            for limit in limit_values:
                for ef_search in ef_search_values:
                    ...
                    # Log results
                    with open('results/qdrant_ann_gist_results_dot.csv', 'a', newline='') as file:
...
print("Experiment for DOT completed.")
