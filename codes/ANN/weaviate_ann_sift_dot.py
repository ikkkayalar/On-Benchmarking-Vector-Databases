...
base_vectors = list(fvecs_read('../../data/sift_base.fvecs'))
query_vectors = list(fvecs_read('../../data/sift_query.fvecs'))

ground_truth_path = '../../data/sift_1m_groundtruth_IP.pkl'
...
distance_metric = "dot"  # Change this for each metric: "l2-squared", "dot", "cosine"
m_values = [8, 16, 32, 64]
...
results_file = f'results/ANN_weaviate_SIFT_results_{distance_metric}.csv'
