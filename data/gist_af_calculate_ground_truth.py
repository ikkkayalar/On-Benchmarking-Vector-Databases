...
base_vectors = list(fvecs_read('gist_base.fvecs'))
query_vectors = list(fvecs_read('gist_query.fvecs'))
...
base_vectors_with_attributes.to_pickle('gist_af_base_vector.pkl')
query_vectors_with_attributes.to_pickle('gist_af_query_vector.pkl')

with open('gist_af_gt_euc.pkl', 'wb') as file:
    pickle.dump(truth, file)

with open('gist_af_gt_cos.pkl', 'wb') as file:
    pickle.dump(truth2, file)

with open('gist_af_gt_dot.pkl', 'wb') as file:
