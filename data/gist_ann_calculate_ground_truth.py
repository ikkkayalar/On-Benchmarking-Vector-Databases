...
base_vectors = list(fvecs_read('gist_base.fvecs')) # gist_base.fvecs
query_vectors = list(fvecs_read('gist_query.fvecs')) # gist_query.fvecs
...
with open('ground_truth_euclidean_gist.pkl', 'wb') as file:
    pickle.dump(truth, file)

with open('ground_truth_cosine_gist.pkl', 'wb') as file:
    pickle.dump(truth2, file)

with open('ground_truth_dot_gist.pkl', 'wb') as file:
    pickle.dump(truth3, file)

base_vectors.to_pickle('base_vectors_gist.pkl') # gist
query_vectors.to_pickle('query_vectors_gist.pkl') # gist